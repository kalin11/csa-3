...
Выполнил Лысенко Артём Константинович P33312 (сдана на 25 из 30, основное замечание - не совсем корректная реализация RISC архитектуры. Все регистры должны быть равноправны, в то время как у меня некоторые регистры были отвественны за что-то конкретное). 
